...
# 输入：图片尺寸为 100 * 40
# img = Image.open(r"D:\data\sina_com_Trains\2a2cb_9272c815b79f7e158fe871303bbda0ea.jpg")
...
dir_path = r'D:\data\sina_com_Trains'
for path in os.listdir(dir_path):
    ...
    img = Image.open(dir_path + '\\' + path).resize((100, 40)).convert('L')
    img_arr = np.reshape(img, 100 * 40)
